        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">Total Products</h6>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">Today's New Products</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ $todaysProducts }}</p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">This Week's New Products</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ $thisWeeksProducts }}</p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">This Month's New Products</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ $thisMonthsProducts }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">This Year's New Products</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ $thisYearsProducts }}</p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">Total Product Value</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ number_format($totalProductValue, 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">Average Product Price</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ number_format($averageProductPrice, 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card position-relative d-flex flex-row align-items-center"
                    ...
                    <div class="content">
                        <h6 class="mb-1" style="color: #6c757d;">Min / Max Product Price</h6>
                        <p class="fw-bold mb-0" style="color: #333; font-size:20px; font-weight:bold">
                            {{ number_format($minimumProductPrice, 2) }} / {{ number_format($maximumProductPrice, 2) }}</p>
                    </div>
                </div>
            </div>
